...
public final class PlayerContract extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // Register commands
        getCommand("kartapc").setExecutor(new com.playercontract.commands.PlayerContractCommand(this));
        getCommand("kartapc").setTabCompleter(new com.playercontract.commands.PlayerContractCommand(this));
